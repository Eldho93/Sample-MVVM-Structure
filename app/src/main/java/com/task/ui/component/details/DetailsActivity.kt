...
class DetailsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.initIntentData(intent.getParcelableExtra(NEWS_ITEM_KEY) ?: NewsItem())
    ...
    private fun initializeView(newsItem: NewsItem) {
        binding.tvName.text = newsItem.title
        binding.tvHeadline.text = newsItem.description
        binding.tvDescription.text = newsItem.content
        Picasso.get().load(newsItem.urlToImage).placeholder(R.drawable.placeholder_image)
